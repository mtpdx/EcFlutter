  ...
  ShoppingCartModel(
      ...
      [
        ...
        OrderModel(
            ...
            '【旗舰新品 稀缺货源】Huawei/华为P30 Pro曲面屏超感光徕卡四摄变',
  ...
  ShoppingCartModel(
      ...
      [
        OrderModel(
            ...
            '【现货速发】Xiaomi/小米小米9 骁龙855全面屏索尼4800万指纹拍照',
            '4G+全网通全息幻彩蓝官方标配6+128GB购机送',
            5,
            2999,
            1),
        OrderModel(
...
//      discounts: '已满150包邮'
  ...
  ShoppingCartModel('lg金捷专卖店', false, false, ShopType.tianMao, [
    OrderModel(
        ...
        '【官方自营】LG 27UK650-W 27英寸10bit 电脑 IPS 4K显示器升降',
        '官方标配;白色',
        0,
        3099,
        1),
  ...
  ShoppingCartModel('Machome苹果家园上', false, false, ShopType.tianMao, [
    OrderModel(
        ...
        '2019新款Apple/苹果MacBook Pro MPXQ2CH/A笔记本电脑选配13 15',
        '19款15/2.3八核i9/16/512银MV932;邮寄;官方标配',
        0,
        18770,
        1),
  ]),
  ShoppingCartModel('苏宁易购官方旗舰', true, false, ShopType.tianMao, [
    OrderModel(
        ...
        '【下单低至4548元】Apple/苹果 iPhone 8 Plus 64G 全网通4G手机 ',
        '无需合约版;银色;官方标配;64GB',
        0,
        4688,
        1),
